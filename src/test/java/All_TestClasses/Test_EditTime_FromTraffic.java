...
public class Test_EditTime_FromTraffic extends A_Base_Class
{
	// Initialise_Brouser();
	// Webdriver driver

	// create object  logger class
	Logger logger = (Logger) LogManager.getLogger("Test_EditTime_FromTraffic");
	...
	@Test  (testName = "Update_Time_From_Traffic")
	public void Update_Time_From_Traffic() throws IOException, InterruptedException 
	{
		...
		try 
		{
			...
			//click created booking for update Time i.e. from 1 AM--> 5:30 AM
			Update_Booking_Traffic.Click_Booking_ToEdit_Time();
		...
		catch(Exception e) 
		{
			...
			extentTest.fail("Update_Time_From_Traffic test case is fail due to" + getCause);
		}
